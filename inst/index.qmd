...
intro <- tryCatch(
    {
        description <- packageDescription("CancerDataSci100")
...
👉 [ghcr.io/vjcitn/cancerdatasci100](https://ghcr.io/vjcitn/cancerdatasci100) 🐳
...
#| eval: false
docker run -it ghcr.io/vjcitn/cancerdatasci100:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/vjcitn/cancerdatasci100:devel
```
